...
public class Inventario {
	...
	public void actualizarInventarioSaludYMedicamentos(Producto productoSeleccionado, int cantidadDisponible) {
	    for (Producto producto : saludYMedicamentos) {
	...
	public void actualizarInventarioAlimentos(String nombre, int cantidadDisponible) {
	    for (Producto producto : alimentos) {
	...
	public void actualizarInventarioElectrodomesticos(String nombre, int cantidadDisponible) {
	    for (Producto producto : electrodomesticos) {
	        if (producto.getNombre().equals(nombre)) {
	            producto.setCantidadDisponible(cantidadDisponible);
	            break;
	...
	public void actualizarInventarioLimpiezaEHigiene(String nombre, int cantidadDisponible) {
	    for (Producto producto : limpiezaEHigiene) {
	        if (producto.getNombre().equals(nombre)) {
	            producto.setCantidadDisponible(cantidadDisponible);
	            break;
	...
	public void actualizarInventarioFerreteria(String nombre, int cantidadDisponible) {
	    for (Producto producto : ferreteria) {
	        if (producto.getNombre().equals(nombre)) {
	            producto.setCantidadDisponible(cantidadDisponible);
	            break;
	...
	public void actualizarInventarioDecoracionYHogar(String nombre, int cantidadDisponible) {
	    for (Producto producto : decoracionYHogar) {
	        if (producto.getNombre().equals(nombre)) {
	            producto.setCantidadDisponible(cantidadDisponible);
	            break;
	...
	public void actualizarInventarioJugueteria(String nombre, int cantidadDisponible) {
	    for (Producto producto : jugueteria) {
	        if (producto.getNombre().equals(nombre)) {
	            producto.setCantidadDisponible(cantidadDisponible);
	            break;
	...
	public void actualizarInventarioTecnologia(String nombre, int cantidadDisponible) {
	    for (Producto producto : tecnologia) {
	        if (producto.getNombre().equals(nombre)) {
	            producto.setCantidadDisponible(cantidadDisponible);
	            break;
	...
	public void actualizarInventarioRopaYAccesorios(String nombre, int cantidadDisponible) {
	    for (Producto producto : ropaYAccesorios) {
	        if (producto.getNombre().equals(nombre)) {
	            producto.setCantidadDisponible(cantidadDisponible);
	            break;
	...
	public void actualizarInventarioLibrosYPapeleria(String nombre, int cantidadDisponible) {
	    for (Producto producto : librosYPapeleria) {
	        if (producto.getNombre().equals(nombre)) {
	            producto.setCantidadDisponible(cantidadDisponible);
	            break;
	...
	public void actualizarInventarioMascotas(String nombre, int cantidadDisponible) {
	    for (Producto producto : mascotas) {
	        if (producto.getNombre().equals(nombre)) {
	            producto.setCantidadDisponible(cantidadDisponible);
	            break;
